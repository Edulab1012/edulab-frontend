                ...
                >
                  ...
                  <div className="relative mt-1">
                    ...
                    <p className="text-sm text-muted-foreground m-2">
                      👉 Энэ кодыг таны багш анги үүсгэх үед гаргаж авсан
                      байдаг. Багш нь тухайн кодыг сурагчидтай хуваалцсанаар та
                      зөв ангид бүртгэгдэх боломжтой болно.
                    </p>
                    <AnimatePresence>
                      {status === "success" && (
                        <motion.span
        ...
        <CardFooter className="flex justify-between pt-4">
          ...
          {!next ? (
            ...
            >
              {loading ? (
                <span className="flex items-center">
                  <Loader2 className="animate-spin mr-2 h-4 w-4" /> Шалгаж
                  байна...
                </span>
              ) : (
                "Үргэлжлүүлэх"
            ...
            >
              {loading ? (
                <span className="flex items-center">
                  <Loader2 className="animate-spin mr-2 h-4 w-4" /> Илгээж
                  байна...
                </span>
              ) : (
                "Бүртгүүлэх"
