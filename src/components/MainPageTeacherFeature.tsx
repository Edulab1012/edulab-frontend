...
const teacherFeatures = [
    {
        id: 1,
        img_url: "/teacher_attendance.png",
        title: "Ирц бүртгэх",
...
export default function TeacherFeatureSelector() {
    ...
    return (
        <div className="w-full min-h-screen py-9 px-4 sm:px-8 bg-[#F3F4F6] dark:bg-[#1E2636] flex items-center justify-center relative mt-30"
            ref={ref}
        >
            <h1 className="bg-gradient-to-r from-[#FF9C42] to-[#B077E0] bg-clip-text text-transparent text-6xl absolute top-[-10%] sm:relative sm:ml-10   ">
                Teacher features
            </h1>
            ...
            >
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                    ...
                    {teacherFeatures.map((item) => (
                        ...
                        >
                            <div className="w-14 h-14 text-white dark:text-[#3e2b22]">
                ...
                <div className="flex flex-col lg:flex-row gap-6 bg-[#2C3A4A] dark:bg-white rounded-2xl p-6 sm:p-8">
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                    ...
                    <div className="flex-1">
                        <motion.h2
                            ...
                            className="text-xl sm:text-2xl lg:text-3xl font-light text-white dark:text-[#3e2b22] mb-3 sm:mb-4"
                        >
                        ...
                        >
                            {selectedTask.content.map((item) => (
                                <div key={item.id} className="flex items-start gap-2 sm:gap-3">
                                    <CheckIcon className="w-4 h-4 sm:w-5 sm:h-5 mt-0.5 text-[#e7dbc6] dark:text-[#d6b591] flex-shrink-0" />
                                    <p className="text-sm sm:text-base text-white dark:text-[#3e2b22]">
                                        {item.option}
                                    </p>
                                </div>
                            ))}
                        ...
                        <motion.p
                            ...
                            className="text-sm sm:text-base text-white dark:text-[#3e2b22]/90"
                        >
